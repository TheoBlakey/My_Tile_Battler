...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private void CreateRooms()
    {
        ...
        listOfcorridors.ForEach(corridor =>
        {
            ...
            {
                ////////////////////////////
                var tempSO = new SimpleRandomWalkSO();
                tempSO.walkLength = corridor.Count;
                corridors.UnionWith(RunRandomWalk(tempSO, corridor[0]));
                corridors.UnionWith(RunRandomWalk(tempSO, corridor[corridor.Count / 2]));
                corridors.UnionWith(RunRandomWalk(tempSO, corridor[corridor.Count - 1]));
                //////////////////////////////
            }
